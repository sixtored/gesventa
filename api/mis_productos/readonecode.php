<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'GET'){
        ...
        // Obtener el id
        $mis_productos->codigo = $_GET['codigo'];
        // Consultar el id
        $mis_productos->readOnecode();
