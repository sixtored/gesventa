...
<body> 
  ...
  <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
    <a class="navbar-brand" href="index3.php">Inicio</a>
 ...
 <?php
       ...
       // echo 'total filas '.$filas.'Total paginas .. '.$paginas ;
        ...
        <div class="row featurette">
            ...
            <h2 class="caption"><?php echo $row["name"]; ?></h2>
 ...
 <hr class="featurette-divider">
      ...
      <ul class="pagination">
        <li class="page-item <?php echo $_GET['pagina']>1 ? '' :'disabled' ?>">
          <a class="page-link" href="index3.php?pagina=<?php echo $_GET['pagina']-1 ?>" >Anterior</a>
        </li>
        <?php for($i=0;$i<$paginas;$i++):?>

        <li class="page-item <?php echo $_GET['pagina'] == $i+1 ? 'active' :'' ?>">
            <a class="page-link" href="index3.php?pagina=<?php echo $i+1 ?>"><?php echo $i+1 ; ?></a>
        </li>
        ...
        <li class="page-item <?php echo $_GET['pagina']<$paginas ? '':'disabled' ?>">
          <a class="page-link" href="index3.php?pagina=<?php echo $_GET['pagina']+1?>">Siguiente</a>
        </li>
      </ul>
    </nav>
